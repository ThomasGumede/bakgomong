...
from accounts.utils.abstracts import Role, PaymentStatus
from contributions.utils.sms import generate_reference
...
def calculate_due_date(recurrence):
    ...
    if recurrence == ContributionType.Recurrence.MONTHLY:
        return today + relativedelta(months=1)
    elif recurrence == ContributionType.Recurrence.ANNUAL:
        return today + relativedelta(years=1)
    elif recurrence == ContributionType.Recurrence.ONCE_OFF:
